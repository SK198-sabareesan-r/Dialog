                        ...
                        'generationConfiguration': {
                            'promptTemplate': {
                                'textPromptTemplate': (
                                    ...
                                    '5. ANSWER ONLY WHAT WAS ASKED - do not provide extra information, features, or anticipate follow-up questions unless directly relevant to answering the specific question\n'
                                    '6. Keep responses concise and focused - avoid over-explaining or adding tangential details\n\n'
                                    'Response Guidelines:\n'
                                    '- Answer directly and concisely without greetings or pleasantries\n'
                                    '- Focus your answer on the specific question asked - extract ONLY the relevant parts from search results\n'
                                    ...
                                    '- Do not add closing remarks, emojis, or ask follow-up questions\n'
                                    '- Keep your tone professional and direct\n'
                                    '- Prioritize brevity: if the question can be answered in 2-3 sentences, do so\n\n'
                                    'Search Results:\n'
                                    '$search_results$\n\n'
                                    'Question: $query$\n\n'
                                    'Your focused response (answer only what was asked):'
                                )
                            },
                        },
                    },
